...
export default function Specialties() {
    ...
    return (
        <section className="py-20 md:py-24 px-8 md:px-12 max-w-[1920px] mx-auto min-h-screen flex flex-col justify-center">
            <ScrollReveal width="100%">
                <h2 className="text-4xl md:text-6xl font-serif font-semibold text-lilac-green text-center mb-12 leading-tight">
                    My Specialties
                </h2>
            </ScrollReveal>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 h-full">
                {specialties.map((item, index) => (
                    <ScrollReveal key={index} delay={index * 0.2} width="100%" className="h-full">
                        <div className="bg-lilac-beige p-8 pb-12 flex flex-col gap-6 border border-lilac-green h-full min-h-[550px] items-center text-center md:text-left md:items-start relative">
                            ...
                            <div className="w-[312px] h-[312px] md:w-[420px] md:h-[420px] rounded-full overflow-hidden bg-gray-300 mt-auto mx-auto relative">
                                <Image
                                    src={item.image}
